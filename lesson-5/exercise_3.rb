...
# ДОМАШНЕЕ ЗАДАНИЕ. Урок 5. Задание 3.
#
...
# Сделано:
# - Обеспечивает хранение данных о количестве кораблей по их типам
# - Предотвращает создание нового корабля, если превышено количество типов данного корабля
...
boat_5 = Ship.new(:boat)              # boat 5 => Катер не создан, их количество не должно превышать 4.
p Ship.ships                                  # => @@ships = {4=>4, 3=>0, 2=>0, 1=>0}
...
destroyer_4 = Ship.new(:destroyer)    # destroyer 4 => > Эсминец не создан, их количество не должно превышать 3.
p Ship.ships                                  # => @@ships = {4=>4, 3=>3, 2=>0, 1=>0}
...
crase_3 = Ship.new(:crase)            # crase 3 => Крейсер не создан, их количество не должно превышать 2.
p Ship.ships                                  # => @@ships = {4=>4, 3=>3, 2=>2, 1=>0}

battleship_1 = Ship.new(:battleship)    # battleship 1
p Ship.ships                                  # => @@ships = {4=>4, 3=>3, 2=>2, 1=>1}

battleship_2 = Ship.new(:battleship)    # battleship 2 => Линкор не создан, их количество не должно превышать 1.
p Ship.ships                                  # => @@ships = {4=>4, 3=>3, 2=>2, 1=>1}
